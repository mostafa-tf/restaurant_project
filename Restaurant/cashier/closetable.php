...
if (isset($_POST['table'])) {
    $sql = "SELECT orderid FROM orderr WHERE payed=0 and orderr.table =" . $_POST['table'];
...
for ($i = 1; $i <= 20; $i++) {
    ...
    $disabled = in_array($i, $reserved) ? "" : "disabled";
    echo "<form action='' method='post'><button name='table' value='$i'  onclick='submit()' class='$class' $disabled>$i</button></form>";
}
